...
function create_config( )
  ...
  config = {
    ...
    about_text = [[Turbo Anti Spam Bot v3

👤SoduBOT
@ArmanTurbo
@Sudo_Turbo

📢 Channel : @Turbo_qp_Bot
...
!plugins enable chat group
🎤 غیر فعال کردن قابلیت چت با ربات
!plugins disable chat group
📝 فعال کردن پیام خوش آمد گویی
!plugins enable welcome group
📝 غیر فعال کردن پیام خوش آمد گویی
!plugins disable welcome group
🃏 ساخت عکس نوشته
!tex [متن]
🃏 ساخت بارکد QR
!qr [متن]
