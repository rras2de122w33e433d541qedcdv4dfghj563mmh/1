...
local function run(msg, matches)
  if matches[1]:lower() == 'turbo' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "turbo" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (turbo)",-- Put everything you like :)
		"^[!/]([Tt]urbo)"-- Put everything you like :)
    }, 
  run = run
}
